 ...
 */
  ...
  _createPlayer: function() {
    document.body.insertAdjacentHTML('beforeEnd', `<canvas id='musicWrapper-canvas'></canvas><div id='musicWrapper-player' style='bottom:-60px'><div id='musicWrapper-pb'><div></div></div><div id='musicWrapper-controls'><span id='musicWrapper-playPauseButton' class='material-icons' style='font-size: 36px'>play_circle_filled</span> <span class='material-icons'>replay_10</span> <span class='material-icons'>repeat_one</span> <span class='material-icons'>insert_chart_outlined</span> <span class='material-icons'>expand_more</span></div><span id='musicWrapper-trackName'></span><span id='musicWrapper-position'></span></div>`);
