 ...
 */
  ...
  _createPlayer: function() {
    document.body.insertAdjacentHTML('beforeEnd', `<canvas id='musicWrapper-canvas'></canvas><div id='musicWrapper-player' style='bottom:-60px'><div id='musicWrapper-pb'><div></div></div><div id='musicWrapper-controls'><span id='musicWrapper-playPauseButton' class='material-icons' style='font-size: 36px' title='Play / Pause'>play_circle_filled</span> <span class='material-icons' title='Rewind 10 Seconds'>replay_10</span> <span class='material-icons' title='Toggle Repeat'>repeat_one</span> <span class='material-icons' style='display:none'>volume_up</span> <span class='material-icons' title='Toggle Visualizer'>insert_chart_outlined</span> <span class='material-icons' title='Hide Player'>expand_more</span></div><span id='musicWrapper-trackName'></span><span id='musicWrapper-position'></span></div>`);
